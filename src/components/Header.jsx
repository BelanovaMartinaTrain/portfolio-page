    ...
    return (
        <header className=" font-light flex flex-col align-middle justify-center w-full z-50 tracking-wider">
            <nav id="menu" className=" flex justify-between  md:flex-row  md:items-center md:justify-around place-items-center">
                <Link to="/">
                    <div className="text-3xl md:text-4xl flex font-dmsans font-medium tracking-widest lg:text-[2.7rem] text-stone-100  pl-4 justify-center sm:justify-start bg-gradient-to-r from-blue-500 via-sky-300 to-blue-500  bg-clip-text text-transparent">
