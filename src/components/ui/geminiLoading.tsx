    ...
    return (
        <div className={cn("h-screen top-[50vh] ", className)}>
            ...
            <svg
                ...
                className=" absolute -top-60 -z-0 md:-top-40 w-full"
            >
                {" "}
                <text
                    textAnchor="middle"
                ...
                <mask id="myMask">
                    <rect x="-10" y="100" width="120%" height="100%" fill="white" />
                    <circle cx="730" cy="500" r="650" fill="black" className="absolute top-0" filter="url(#blurPath)" />
                </mask>{" "}
                <motion.path
                ...
                <path
                    ...
                    filter="url(#blurMe)"
                />
                <rect x="-10" y="100" width="1700" height="100%" fill="black" mask="url(#myMask)" />
                <defs>
                    <filter id="blurMe">
