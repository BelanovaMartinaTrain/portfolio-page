    ...
    return (
        <>
            ...
            <div className="w-full  grid justify-center">
                <div className="flex gap-x-4 justify-end mt-2 print:hidden  ">
                ...
                {data && (
                    <div className="p-4 print:p-0 bg-slate-950 text-neutral-300 border border-blue-950/[0.5] rounded-lg print:border-none mt-4 print:mt-0 print:text-black max-w-6xl print:max-w-7xl w-full gap-4 text-normal print:text-xs grid grid-cols-3">
                        <div className="col-span-2 p-4 print:p-0">
                            ...
                            <h3 className="mt-4 print:text-sm">Work experience:</h3>
                            {data.work.map((job) => (
                        ...
                        <div className="col-span-1 flex p-1  print:p-0 ">
                            <div className=" print:border print:border-l-slate-800/[0.5]  w-px h-full mr-4 bg-gradient-to-t from-transparent via-slate-700 to-transparent"></div>
                            <div className="mt-1">
                                <div className="print:border-none  print:p-0    mb-6">
