            ...
            <CanvasRevealEffectDemo3>
                <div className=" sm:p-12  p-4 rounded-2xl z-50 ">
                    <div className="grid lg:grid-cols-8 lg:grid-rows-2  grid-flow-row tracking-wider">
                        ...
                        <section className="text-lg md:text-xl lg:text-2xl leading-9 text-center text-stone-200 font-dmsans   grid-flow-col sm:col-span-6 sm:col-start-2 sm:align-middle sm:row-span-2 sm:items-center sm:justify-between sm:self-center">
                            <h1 className="text-xl md:text-2xl lg:text-3xl font-semibold mt-5 z-50 uppercase ">Ahoj!</h1>
